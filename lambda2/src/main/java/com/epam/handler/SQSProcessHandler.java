...
public class SQSProcessHandler implements RequestHandler<Map<String, Object>, APIGatewayProxyResponseEvent> {

  private static final String SNS_QUEUE_NAME = "web-uploads-notification-queue";
  private static final String TOPIC_ARN = "arn:aws:sns:us-east-1:923149581209:web-uploads-notification-topic";
